...
#else
	return LOAD_TEXTURE2D_X(_CrestOceanMaskTexture, uv).r;
#endif
}
...
#ifdef UNITY_SAMPLE_SCREENSPACE_TEXTURE
...
#endif // UNITY_SAMPLE_SCREENSPACE_TEXTURE

void GetOceanSurfaceAndUnderwaterData(
#ifdef TEXTURE2D_X
	const uint2 positionSS,
#else
...
)
{
...
#ifdef TEXTURE2D_X
		sceneZ = CrestLinearEyeDepth(CrestMultiLoadDepth(_CrestOceanMaskDepthTexture, rawDepth, positionSS));
#else
	...
	{
#ifdef TEXTURE2D_X
		sceneZ = CrestLinearEyeDepth(CrestMultiLoadDepth(_CameraDepthTexture, rawDepth, positionSS));
#else
