Shader "Hidden/Shader/FogEffect"
{
    ...
    float4 CustomPostProcess(Varyings input) : SV_Target
    {
        ...
        float depthValue =1- SAMPLE_TEXTURE2D_X(_CameraDepthTexture, s_linear_clamp_sampler, input.texcoord).xyz;
        //float dpth = Linear01Depth(depthValue);
        ...
        return col4 + (depthValue * _Intensity) * (fogColor - col4);
    }
